...
#### LRU 리스트
![lru_list](https://dev.mysql.com/doc/refman/8.0/en/images/innodb-buffer-pool-list.png)<br />
...
- 데이터 변경되어 올라간 LSN(Log Sequence Number) <br />
![lsn.png](..%2F..%2Fimg%2Fdb%2Flsn.png)
- 체크 포인트 이벤트 후 LSN<br />
![checkpoint.png](..%2F..%2Fimg%2Fdb%2Fcheckpoint.png)
- 체크 포인트 후 데이터 변경<br />
![checkpointlsn.png](..%2F..%2Fimg%2Fdb%2Fcheckpointlsn.png)<br />
